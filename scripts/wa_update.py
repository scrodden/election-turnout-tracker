...
GEO_PATH = os.path.join(ROOT, "assets", "wa-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "WA Secretary of State Ballot Return Statistics (turnout-only; WA has no party registration)"},
