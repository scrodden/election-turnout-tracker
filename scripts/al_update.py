...
STATE = "al"
CONFIG_PATH = os.path.join(ROOT, "config", "al.json")
GEO_PATH = os.path.join(ROOT, "assets", "al-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Alabama ballot/turnout data (turnout-only)"},
