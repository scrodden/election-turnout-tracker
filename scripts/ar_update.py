...
STATE = "ar"
CONFIG_PATH = os.path.join(ROOT, "config", "ar.json")
GEO_PATH = os.path.join(ROOT, "assets", "ar-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Arkansas ballot/turnout data (turnout-only)"},
