...
STATE = "mo"
CONFIG_PATH = os.path.join(ROOT, "config", "mo.json")
GEO_PATH = os.path.join(ROOT, "assets", "mo-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Missouri ballot/turnout data (turnout-only)"},
