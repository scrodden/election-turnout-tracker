...
STATE = "sc"
CONFIG_PATH = os.path.join(ROOT, "config", "sc.json")
GEO_PATH = os.path.join(ROOT, "assets", "sc-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "South Carolina ballot/turnout data (turnout-only)"},
