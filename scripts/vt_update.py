...
STATE = "vt"
CONFIG_PATH = os.path.join(ROOT, "config", "vt.json")
GEO_PATH = os.path.join(ROOT, "assets", "vt-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Vermont ballot/turnout data (turnout-only)"},
