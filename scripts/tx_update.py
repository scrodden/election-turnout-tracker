...
STATE = "tx"
CONFIG_PATH = os.path.join(ROOT, "config", "tx.json")
GEO_PATH = os.path.join(ROOT, "assets/tx-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Texas Secretary of State early voting turnout (turnout-only; TX has no party registration)"},
