...
STATE = "in"
CONFIG_PATH = os.path.join(ROOT, "config", "in.json")
GEO_PATH = os.path.join(ROOT, "assets", "in-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Indiana ballot/turnout data (turnout-only)"},
