...
STATE = "tn"
CONFIG_PATH = os.path.join(ROOT, "config", "tn.json")
GEO_PATH = os.path.join(ROOT, "assets", "tn-counties.geojson")
...
def main():
    ...
    snap = {
        ...
        "partisan": False,
        "source": {"primary": "Tennessee ballot/turnout data (turnout-only)"},
